...
class Post(models.Model):
    ...
    # auto_now will update everytime when we save the model.
    # auto_now_add is set only on create. If we use the auto_now_add, then we cannot set the field
    # manually on our model.
